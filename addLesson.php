...
if(isset($_REQUEST['lessonSubmitBtn'])){
    ...
    if(($_REQUEST['lesson_name'] =="") || ($_REQUEST['lesson_desc'] =="") || ($_REQUEST['course_id'] =="") || ($_REQUEST['course_name'] =="")) {
        ...
        $sql = "INSERT INTO lesson (lesson_name, lesson_desc, lesson_link, course_id,
         course_name) VALUES ('$lesson_name', '$lesson_desc', '$link_folder', '$course_id', '$course_name')";
        ...
        if($con->query($sql)== TRUE){
            $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-5">Lesson Added Successfully!</div>';

        }
        else {
          $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-5">Unabel to Add Lesson</div>';
        }
    }
}
?>
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <div class="form-group">
        ...
        name="course_id" value="<?php  if(isset($_SESSION['course_id'])) 
        { echo $_SESSION['course_id']; }?>" readonly>
    </div>
    <div class="form-group">
        <label for="course_name">Course Name</label>
        <input type="text" class="form-control" id="course_name" 
        name="course_name" value="<?php  if(isset($_SESSION['course_name'])) 
